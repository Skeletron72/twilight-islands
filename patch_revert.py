...
# Replace the 2x generation with the 1x generation, but strictly enforce 2x2 minimum feature size via rules
old_gen = """	# Размеры залов случайные и могут быть больше
