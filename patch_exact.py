...
old_map = """				# Внешние углы (Правильный маппинг для 2x2 блоков, темная сторона наружу)
...
new_map = """				# Внешние углы (Теперь используем тайлы внутренних углов пустоты!)
...
new_vert = """					# Inner corners (swapped)
